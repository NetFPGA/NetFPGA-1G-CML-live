...
BEGIN nf10_router_output_port_lookup
 PARAMETER INSTANCE = nf10_router_output_port_lookup_0
 PARAMETER HW_VER = 1.00.a
 PARAMETER C_INTERCONNECT_S_AXI_IS_ACLK_ASYNC = 1
 PARAMETER C_M_AXIS_DATA_WIDTH = 256
 PARAMETER C_S_AXIS_DATA_WIDTH = 256
 PARAMETER C_BAR0_BASEADDR = 0x76800000
 PARAMETER C_BAR0_HIGHADDR = 0x7680FFFF
 PARAMETER C_BAR1_BASEADDR = 0x74800000
 PARAMETER C_BAR1_HIGHADDR = 0x7480FFFF
 BUS_INTERFACE S_AXI = axi_interconnect_0
 BUS_INTERFACE S_AXIS = nf10_endianess_manager_0_M_AXIS_INT
 BUS_INTERFACE M_AXIS = nf10_router_output_port_lookup_0_M_AXIS
...
BEGIN nf10_bram_output_queues
 ...
 BUS_INTERFACE S_AXIS = nf10_endianess_manager_0_M_AXIS
 PORT axi_aclk = core_clk
 PORT axi_resetn = Peripheral_aresetn
END
...
BEGIN nf10_endianess_manager
 PARAMETER INSTANCE = nf10_endianess_manager_0
 PARAMETER HW_VER = 1.00.a
 PARAMETER C_S_AXIS_TDATA_WIDTH = 256
 PARAMETER C_M_AXIS_TDATA_WIDTH = 256
 BUS_INTERFACE S_AXIS = nf10_input_arbiter_0_M_AXIS
 BUS_INTERFACE M_AXIS_INT = nf10_endianess_manager_0_M_AXIS_INT
 BUS_INTERFACE S_AXIS_INT = nf10_router_output_port_lookup_0_M_AXIS
 BUS_INTERFACE M_AXIS = nf10_endianess_manager_0_M_AXIS
