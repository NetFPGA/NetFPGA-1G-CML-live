...
"""Network Client NT01 Host Support
...
if __name__ == '__main__':
	...
	print
	print "This is a interactive python shell. Use dir() and help(func) for more information."
	...
	#funcs = ["%-16s : %s" % (f.__name__, f.__doc__) for f in globals().values() if type(f)==types.FunctionType]
