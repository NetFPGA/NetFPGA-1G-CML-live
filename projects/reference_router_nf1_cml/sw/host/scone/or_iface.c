...
void read_hw_iface_mac(router_state *rs, unsigned int port, unsigned int *mac_hi, unsigned int *mac_lo) {
	...
	switch(port) {
		...
		case 0:
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_0_HI_REG, mac_hi);
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_0_LO_REG, mac_lo);
			break;

		case 1:
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_1_HI_REG, mac_hi);
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_1_LO_REG, mac_lo);
			break;

		case 2:
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_2_HI_REG, mac_hi);
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_2_LO_REG, mac_lo);
			break;
		case 3:
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_3_HI_REG, mac_hi);
			readReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_3_LO_REG, mac_lo);
			break;
		default:
...
void write_hw_iface_mac(router_state *rs, unsigned int port, unsigned int mac_hi, unsigned int mac_lo) {
	...
	switch(port) {
		...
		case 0:
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_0_HI_REG, mac_hi);
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_0_LO_REG, mac_lo);
			break;

		case 1:
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_1_HI_REG, mac_hi);
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_1_LO_REG, mac_lo);
			break;

		case 2:
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_2_HI_REG, mac_hi);
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_2_LO_REG, mac_lo);
			break;
		case 3:
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_3_HI_REG, mac_hi);
			writeReg(rs->netfpga_regs, ROUTER_OP_LUT_MAC_3_LO_REG, mac_lo);
			break;
		default:
