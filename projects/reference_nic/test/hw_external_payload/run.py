...
#                             pkt_len=random.randint(60,1514)))
	pkts[port].append(make_IP_hdr(dst_MAC=DA, src_MAC=SA, dst_IP=DST_IP,
                             src_IP=SRC_IP, TTL=TTL,pkt_len=64)/"AAAAAAAAAABBBBBBBBBBLLLCCCCCCCDDDDDDDDDDEEEEEEEEEEFFFFFFFFFFGGGGGGGGGG");
